...
-- Dumping data for table database_1931557.customers: ~3 rows (approximately)
...
WHERE purchases_view_all.`Creation Date`>= p_creation_date OR purchases_view_all.`Creation Date` = NULL;
...
-- Dumping data for table database_1931557.purchases: ~9 rows (approximately)
